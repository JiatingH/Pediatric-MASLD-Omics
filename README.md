...
This repository contains the R scripts for the Pediatric-MASLD-Omics project. The study explores the associations between the gut microbiome and host metabolism in children with MASLD
